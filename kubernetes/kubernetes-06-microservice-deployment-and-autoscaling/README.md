...
#top komutuyla objelerin cpu ve memory lerini gorebiliyoruz. yani process leri gosteriyor.
```
...
# burada /dev/null komutu ile cikti vermiyor arka planda uyguluyor.
```
