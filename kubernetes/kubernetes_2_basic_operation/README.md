...
#-l ile listeleme yapiyor. app=.. ile de eslesen durumlari getiriyor.
```
...
#burada deploy un gecmisteki rollout durumunu gorebiliyoruz. 
```
...
#bastaki sayi revisionunu veriyor. onun hakkinda bilgi almak icin --revision=1 diyoruz.
```
...
#edit ile vi editoru gibi iceri girip duzenleme yapabiliyoruz. insert moduna gecip i ye basarak duzenleme yapabiliyoruz.
```
...
#undo bunu begenmedim --to-revision=1 komutu ile 1. revisiona donebiliyoruz.
```
...
#kubectl get deployment -A ile de tum name space deki deploymentlari gorebilirim.
```
